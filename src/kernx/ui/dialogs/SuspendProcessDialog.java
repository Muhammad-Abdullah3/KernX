...
public class SuspendProcessDialog extends JDialog {
    ...
    public SuspendProcessDialog(Window parent, ProcessTablePanel tablePanel) {
        super(parent, "Suspend Process", ModalityType.APPLICATION_MODAL);
