...
public class BlockProcessDialog extends JDialog {
    ...
    public BlockProcessDialog(Window parent, ProcessTablePanel tablePanel) {
        super(parent, "Block Process", ModalityType.APPLICATION_MODAL);
