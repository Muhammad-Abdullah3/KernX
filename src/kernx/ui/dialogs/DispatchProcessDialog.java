...
public class DispatchProcessDialog extends JDialog {
    ...
    public DispatchProcessDialog(Window parent, ProcessTablePanel tablePanel) {
        super(parent, "Dispatch Process", ModalityType.APPLICATION_MODAL);
